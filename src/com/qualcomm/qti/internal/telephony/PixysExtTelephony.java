...
public class PixysExtTelephony extends IExtTelephony.Stub {
    ...
    private static PixysExtTelephony sInstance;
    ...
    public static PixysExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new PixysExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private PixysExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
